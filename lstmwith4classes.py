# -*- coding: utf-8 -*-
"""LSTMwith4Classes.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1NZkV2z1E198ijjV5a7TbCytKlKMOMAoz
"""
...
#folder = ["GrippingLeft",  "GrippingOnly", "GrippingWithDiffForce"]

max_dataarraysize = 30052
#max_dataarraysize = 3387
...
#X_train, X_test, y_train, y_test = train_test_split(data_collect, label, test_size=0.2, random_state=9)
...
with tf.distribute.MirroredStrategy().scope():
    ...
    model.add(LSTM(hid_dim, input_shape=X_train.shape[1:], activation = 'relu', dropout=0.01)) 
...
history = model.fit(X_train, y_train, batch_size=256, epochs=epochs, validation_data=(X_test, y_test))
